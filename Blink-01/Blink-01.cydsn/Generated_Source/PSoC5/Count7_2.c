...
uint8 Count7_2_initVar = 0u;


/*******************************************************************************
* Function Name: Count7_2_Init
********************************************************************************
*
* Summary:
...
void Count7_2_Init(void) 
{
    ...
    Count7_2_PERIOD_REG = Count7_2_INITIAL_PERIOD;
}


/*******************************************************************************
* Function Name: Count7_2_Enable
********************************************************************************
*
* Summary:
...
void Count7_2_Enable(void) 
{
    ...
    */
    Count7_2_AUX_CONTROL_REG |= Count7_2_COUNTER_START;
...
*
* Global Variables:
*  Count7_2_initVar - global variable.
*
* Return:
*  None.
*
...
void Count7_2_Stop(void) 
{
    ...
    Count7_2_AUX_CONTROL_REG &= (uint8) ~((uint8) Count7_2_COUNTER_START);
...
/*******************************************************************************
* Function Name: Count7_2_WriteCounter
********************************************************************************
*
* Summary:
...
{
    Count7_2_COUNT_REG = (count & Count7_2_COUNT_7BIT_MASK);
}


/*******************************************************************************
* Function Name: Count7_2_ReadCounter
********************************************************************************
*
* Summary:
...
{
    return(Count7_2_COUNT_REG & Count7_2_COUNT_7BIT_MASK);
}


/*******************************************************************************
* Function Name: Count7_2_WritePeriod
********************************************************************************
*
* Summary:
...
{
    Count7_2_PERIOD_REG = period;
}


/*******************************************************************************
* Function Name: Count7_2_ReadPeriod
********************************************************************************
*
* Summary:
