// ======================================================================
// RPPSOC-PWM.v generated from TopDesign.cysch
// 10/19/2016 at 07:50
...
module top ;
    ...
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_487 or Net_498 or Net_497)
        begin
            case (Net_497)
                1'b0 :  tmp__mux_1_reg = Net_487;
                1'b1 :  tmp__mux_1_reg = Net_498;
            endcase
        end
        assign Net_473 = tmp__mux_1_reg;
    end
    // -- Mux end --
    ...
    begin : mux_2
        reg  tmp__mux_2_reg;
        always @(Net_487 or Net_494 or Net_503)
        begin
            case (Net_503)
                1'b0 :  tmp__mux_2_reg = Net_487;
                1'b1 :  tmp__mux_2_reg = Net_494;
            endcase
        end
        assign Net_495 = tmp__mux_2_reg;
    end
    // -- Mux end --
    ...
    begin : mux_3
        reg  tmp__mux_3_reg;
        always @(Net_487 or Net_498 or Net_507)
        begin
            case (Net_507)
                1'b0 :  tmp__mux_3_reg = Net_487;
                1'b1 :  tmp__mux_3_reg = Net_498;
            endcase
        end
        assign Net_506 = tmp__mux_3_reg;
    end
    // -- Mux end --
    ...
    begin : mux_4
        reg  tmp__mux_4_reg;
        always @(Net_487 or Net_494 or Net_511)
        begin
            case (Net_511)
                1'b0 :  tmp__mux_4_reg = Net_487;
                1'b1 :  tmp__mux_4_reg = Net_494;
            endcase
        end
        assign Net_510 = tmp__mux_4_reg;
    end
    // -- Mux end --
    ...
    assign Net_554 = Net_548 & Net_547 & Net_546 & Net_549 & Net_550 & Net_551 & Net_552 & Net_553;
    ...
    assign Net_559 = Net_533 & Net_532 & Net_531 & Net_538 & Net_539 & Net_534 & Net_535 & Net_536;
    ...
    assign Net_556 = Net_554 ^ Net_559;
