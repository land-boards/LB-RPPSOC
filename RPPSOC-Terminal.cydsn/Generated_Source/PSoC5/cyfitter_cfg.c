...
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x48000CC0u)
...
#define BS_IOPINS0_4_VAL ((const uint8 CYFAR *)0x48000CE0u)

/* IOPINS0_5 Address: CYREG_PRT5_DR Size (bytes): 10 */
#define BS_IOPINS0_5_VAL ((const uint8 CYFAR *)0x48000CE8u)
