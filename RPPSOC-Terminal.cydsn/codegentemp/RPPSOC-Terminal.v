// ======================================================================
// RPPSOC-Terminal.v generated from TopDesign.cysch
// 11/05/2016 at 13:59
...
// ILO_Trim_v2_0(CtlModeReplacementString=Sync, DeviceFamily=PSoC5, FixedFunction=true, FixedFunctionUsed=1, SiliconRevision=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=ILO_Trim_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ILO_Trim_1, CY_INSTANCE_SHORT_NAME=ILO_Trim_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=ILO_Trim_1, )
module ILO_Trim_v2_0_0 (
    ref_clk);
    input       ref_clk;
    ...
    cy_psoc3_timer_v1_0 bILO_Trim_FF_Timer (
        .timer_reset(Net_290),
        .capture(Net_290),
        .enable(Net_23),
        .kill(Net_24),
	...
	cy_clock_v1_0
		#(.id("c56ea238-e14b-4607-8ad8-15fa6aa00a27/0d4cd06d-e852-4d36-a25a-9d5d75aef668"),
...
module top ;
	...
	wire [0:0] tmpOE__HBLANK_net;
	wire [0:0] tmpFB_0__HBLANK_net;
	wire [0:0] tmpIO_0__HBLANK_net;
	wire [0:0] tmpINTERRUPT_0__HBLANK_net;
	electrical [0:0] tmpSIOVREF__HBLANK_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("2eed55c8-831a-4b33-9a1a-8ff42fcfe93a"),
		  ...
		  .input_buffer_sel(2'b00))
		HBLANK
		 (.oe(tmpOE__HBLANK_net),
		  .y({Net_562}),
		  .fb({tmpFB_0__HBLANK_net[0:0]}),
		  .io({tmpIO_0__HBLANK_net[0:0]}),
		  .siovref(tmpSIOVREF__HBLANK_net),
		  .interrupt({tmpINTERRUPT_0__HBLANK_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HBLANK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__VBLANK_net;
	wire [0:0] tmpFB_0__VBLANK_net;
	wire [0:0] tmpIO_0__VBLANK_net;
	wire [0:0] tmpINTERRUPT_0__VBLANK_net;
	electrical [0:0] tmpSIOVREF__VBLANK_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("76e558d2-2e3d-451d-acb9-2b5ddd5d7dce"),
		  ...
		  .input_buffer_sel(2'b00))
		VBLANK
		 (.oe(tmpOE__VBLANK_net),
		  .y({Net_576}),
		  .fb({tmpFB_0__VBLANK_net[0:0]}),
		  .io({tmpIO_0__VBLANK_net[0:0]}),
		  .siovref(tmpSIOVREF__VBLANK_net),
		  .interrupt({tmpINTERRUPT_0__VBLANK_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VBLANK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HSYNC_net;
	wire [0:0] tmpFB_0__HSYNC_net;
    ...
    assign Net_576 = (Net_538[9:0] >= Net_577[9:0]);

	wire [0:0] tmpOE__P4_18_net;
	wire [0:0] tmpFB_0__P4_18_net;
	wire [0:0] tmpIO_0__P4_18_net;
	wire [0:0] tmpINTERRUPT_0__P4_18_net;
	electrical [0:0] tmpSIOVREF__P4_18_net;
	...
	cy_psoc3_pins_v1_10
		...
		P4_18
		 (.oe(tmpOE__P4_18_net),
		  .y({Net_129}),
		  .fb({tmpFB_0__P4_18_net[0:0]}),
		  .io({tmpIO_0__P4_18_net[0:0]}),
		  .siovref(tmpSIOVREF__P4_18_net),
		  .interrupt({tmpINTERRUPT_0__P4_18_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__P4_18_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__P4_17_net;
	wire [0:0] tmpFB_0__P4_17_net;
	wire [0:0] tmpIO_0__P4_17_net;
	wire [0:0] tmpINTERRUPT_0__P4_17_net;
	electrical [0:0] tmpSIOVREF__P4_17_net;
	...
	cy_psoc3_pins_v1_10
		...
		P4_17
		 (.oe(tmpOE__P4_17_net),
		  .y({Net_137}),
		  .fb({tmpFB_0__P4_17_net[0:0]}),
		  .io({tmpIO_0__P4_17_net[0:0]}),
		  .siovref(tmpSIOVREF__P4_17_net),
		  .interrupt({tmpINTERRUPT_0__P4_17_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
    ...
    assign Net_568 = Net_567 & Net_575;
    ...
    assign CharClk = (Net_655[2:0] == Net_657[2:0]);
    ...
    BasicCounter_v1_0 CharacterCounter (
        .en(Net_442),
        .cnt(Net_655[2:0]),
        .reset(Net_444),
        .clock(Net_445));
    ...
    assign Net_593[9:0] = 10'h20D;


    assign Net_608 = ~(Net_602 ^ Net_601 ^ Net_600 ^ Net_603 ^ Net_604 ^ Net_605 ^ Net_606 ^ Net_607);


    assign Net_619 = ~(Net_611 ^ Net_610 ^ Net_609 ^ Net_612 ^ Net_613 ^ Net_614 ^ Net_615 ^ Net_616);
    ...
    ILO_Trim_v2_0_0 ILO_Trim_1 (
        .ref_clk(Net_705));
    defparam ILO_Trim_1.DeviceFamily = "PSoC5";
    defparam ILO_Trim_1.SiliconRevision = "0";


	cy_clock_v1_0
		#(.id("66d8bcd6-d590-41d3-9d28-fafe5d7e229b"),
		  .source_clock_id(""),
		  .divisor(0),
