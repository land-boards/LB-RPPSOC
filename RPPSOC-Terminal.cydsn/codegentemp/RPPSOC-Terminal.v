...
// ILO_Trim_v2_0(CtlModeReplacementString=Sync, DeviceFamily=PSoC5, FixedFunction=true, FixedFunctionUsed=1, SiliconRevision=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=ILO_Trim_v2_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ILO_Trim_1, CY_INSTANCE_SHORT_NAME=ILO_Trim_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3, INSTANCE_NAME=ILO_Trim_1, )
