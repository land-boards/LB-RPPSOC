...
#define HEX_FILE_DEVICE_FAMILY      HEX_FILE_PSOC3_DEVICE_FAMILY

#define FLASH_CFG_DATA_PRESENT_HEX_FILE       0u

#define EEPROM_DATA_PRESENT_HEX_FILE       1u

#define NUMBER_OF_EEPROM_ROWS_HEX_FILE      64u
#define NUMBER_OF_EEPROM_SECTORS_HEX_FILE      1u
#define EEPROM_ROW_BYTE_SIZE_HEX_FILE      16u
#define NUMBER_OF_FLASH_ARRAYS_HEX_FILE      1u
#define NUMBER_OF_FLASH_ROWS_HEX_FILE        128u
#define FLASH_ROW_BYTE_SIZE_HEX_FILE         256u
#define FLASH_PROTECTION_BYTE_SIZE_HEX_FILE  32u
