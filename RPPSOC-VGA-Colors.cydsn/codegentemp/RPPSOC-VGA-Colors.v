...
module top ;
	...
	wire [0:0] tmpOE__COMP_SYNC_net;
	wire [0:0] tmpFB_0__COMP_SYNC_net;
	wire [0:0] tmpIO_0__COMP_SYNC_net;
	wire [0:0] tmpINTERRUPT_0__COMP_SYNC_net;
	electrical [0:0] tmpSIOVREF__COMP_SYNC_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("5b96afab-c92f-4255-80a2-b58df2ee206e"),
		  ...
		  .input_buffer_sel(2'b00))
		COMP_SYNC
		 (.oe(tmpOE__COMP_SYNC_net),
		  .y({Net_765}),
		  .fb({tmpFB_0__COMP_SYNC_net[0:0]}),
		  .io({tmpIO_0__COMP_SYNC_net[0:0]}),
		  .siovref(tmpSIOVREF__COMP_SYNC_net),
		  .interrupt({tmpINTERRUPT_0__COMP_SYNC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	wire [0:0] tmpOE__GRN_net;
	wire [0:0] tmpFB_0__GRN_net;
	wire [0:0] tmpIO_0__GRN_net;
	wire [0:0] tmpINTERRUPT_0__GRN_net;
	electrical [0:0] tmpSIOVREF__GRN_net;
	...
	cy_psoc3_pins_v1_10
		...
		GRN
		 (.oe(tmpOE__GRN_net),
		  .y({Net_755}),
		  .fb({tmpFB_0__GRN_net[0:0]}),
		  .io({tmpIO_0__GRN_net[0:0]}),
		  .siovref(tmpSIOVREF__GRN_net),
		  .interrupt({tmpINTERRUPT_0__GRN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__GRN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
