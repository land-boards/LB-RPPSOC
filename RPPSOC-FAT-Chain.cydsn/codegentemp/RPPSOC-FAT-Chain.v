// ======================================================================
// RPPSOC-FAT-Chain.v generated from TopDesign.cysch
// 05/30/2016 at 15:00
...
module top ;
	...
	wire [0:0] tmpOE__RP_SPI_CE0_net;
	wire [0:0] tmpIO_0__RP_SPI_CE0_net;
	wire [0:0] tmpINTERRUPT_0__RP_SPI_CE0_net;
	electrical [0:0] tmpSIOVREF__RP_SPI_CE0_net;

	cy_psoc3_pins_v1_10
		#(.id("a4d01e19-1c66-4c0a-ac0e-1af9677c148b"),
		  .drive_mode(3'b111),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		RP_SPI_CE0
		 (.oe(tmpOE__RP_SPI_CE0_net),
		  .y({1'b0}),
		  .fb({Net_303}),
		  .io({tmpIO_0__RP_SPI_CE0_net[0:0]}),
		  .siovref(tmpSIOVREF__RP_SPI_CE0_net),
		  .interrupt({tmpINTERRUPT_0__RP_SPI_CE0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RP_SPI_CE0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__RP_SPI_SCLK_net;
	wire [0:0] tmpIO_0__RP_SPI_SCLK_net;
	wire [0:0] tmpINTERRUPT_0__RP_SPI_SCLK_net;
	electrical [0:0] tmpSIOVREF__RP_SPI_SCLK_net;

	cy_psoc3_pins_v1_10
		#(.id("3a4d3c1f-084e-45aa-b8c9-014e38c9f463"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		RP_SPI_SCLK
		 (.oe(tmpOE__RP_SPI_SCLK_net),
		  .y({1'b0}),
		  .fb({Net_302}),
		  .io({tmpIO_0__RP_SPI_SCLK_net[0:0]}),
		  .siovref(tmpSIOVREF__RP_SPI_SCLK_net),
		  .interrupt({tmpINTERRUPT_0__RP_SPI_SCLK_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RP_SPI_SCLK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__RP_SPI_MISO_net;
	wire [0:0] tmpFB_0__RP_SPI_MISO_net;
	wire [0:0] tmpIO_0__RP_SPI_MISO_net;
	wire [0:0] tmpINTERRUPT_0__RP_SPI_MISO_net;
	electrical [0:0] tmpSIOVREF__RP_SPI_MISO_net;

	cy_psoc3_pins_v1_10
		#(.id("18e3498f-3120-475f-9fc6-b44bf7b968ba"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		RP_SPI_MISO
		 (.oe(tmpOE__RP_SPI_MISO_net),
		  .y({Net_205}),
		  .fb({tmpFB_0__RP_SPI_MISO_net[0:0]}),
		  .io({tmpIO_0__RP_SPI_MISO_net[0:0]}),
		  .siovref(tmpSIOVREF__RP_SPI_MISO_net),
		  .interrupt({tmpINTERRUPT_0__RP_SPI_MISO_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RP_SPI_MISO_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpFB_0__RP_GPIO_12_net;
	...
	cy_psoc3_pins_v1_10
		...
		RP_GPIO_12
		 (.oe(tmpOE__RP_GPIO_12_net),
		  .y({Net_157}),
		  .fb({tmpFB_0__RP_GPIO_12_net[0:0]}),
	...
	wire [0:0] tmpOE__RP_GPIO_4_net;
	wire [0:0] tmpFB_0__RP_GPIO_4_net;
	wire [0:0] tmpIO_0__RP_GPIO_4_net;
	wire [0:0] tmpINTERRUPT_0__RP_GPIO_4_net;
	electrical [0:0] tmpSIOVREF__RP_GPIO_4_net;

	cy_psoc3_pins_v1_10
		#(.id("46970eb1-1c56-482e-9a00-f40a5d94a111"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		RP_GPIO_4
		 (.oe(tmpOE__RP_GPIO_4_net),
		  .y({Net_157}),
		  .fb({tmpFB_0__RP_GPIO_4_net[0:0]}),
		  .io({tmpIO_0__RP_GPIO_4_net[0:0]}),
		  .siovref(tmpSIOVREF__RP_GPIO_4_net),
		  .interrupt({tmpINTERRUPT_0__RP_GPIO_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RP_GPIO_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__RP_SPI_MOSI_net;
	wire [0:0] tmpFB_0__RP_SPI_MOSI_net;
	wire [0:0] tmpIO_0__RP_SPI_MOSI_net;
	wire [0:0] tmpINTERRUPT_0__RP_SPI_MOSI_net;
	electrical [0:0] tmpSIOVREF__RP_SPI_MOSI_net;

	cy_psoc3_pins_v1_10
		#(.id("4f1a1a5f-7838-41b6-aac8-0525c387edeb"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		RP_SPI_MOSI
		 (.oe(tmpOE__RP_SPI_MOSI_net),
		  .y({Net_304}),
		  .fb({tmpFB_0__RP_SPI_MOSI_net[0:0]}),
		  .io({tmpIO_0__RP_SPI_MOSI_net[0:0]}),
		  .siovref(tmpSIOVREF__RP_SPI_MOSI_net),
		  .interrupt({tmpINTERRUPT_0__RP_SPI_MOSI_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RP_SPI_MOSI_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__RP_GPIO_13_net;
	wire [0:0] tmpFB_0__RP_GPIO_13_net;
	...
	cy_psoc3_pins_v1_10
		...
		RP_GPIO_13
		 (.oe(tmpOE__RP_GPIO_13_net),
		  .y({Net_92}),
		  .fb({tmpFB_0__RP_GPIO_13_net[0:0]}),
	...
	wire [0:0] tmpOE__RP_SPI_CE1_net;
	wire [0:0] tmpIO_0__RP_SPI_CE1_net;
	wire [0:0] tmpINTERRUPT_0__RP_SPI_CE1_net;
	electrical [0:0] tmpSIOVREF__RP_SPI_CE1_net;

	cy_psoc3_pins_v1_10
		#(.id("5d15e481-31c7-448f-85b3-43630fe3ec4b"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		RP_SPI_CE1
		 (.oe(tmpOE__RP_SPI_CE1_net),
		  .y({1'b0}),
		  .fb({Net_304}),
		  .io({tmpIO_0__RP_SPI_CE1_net[0:0]}),
		  .siovref(tmpSIOVREF__RP_SPI_CE1_net),
		  .interrupt({tmpINTERRUPT_0__RP_SPI_CE1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RP_SPI_CE1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__RP_UART_RX_net;
	wire [0:0] tmpFB_0__RP_UART_RX_net;
	wire [0:0] tmpIO_0__RP_UART_RX_net;
	wire [0:0] tmpINTERRUPT_0__RP_UART_RX_net;
	electrical [0:0] tmpSIOVREF__RP_UART_RX_net;

	cy_psoc3_pins_v1_10
		#(.id("e9fcc41c-3f35-4a80-9c6d-79f9e726d8f4"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		RP_UART_RX
		 (.oe(tmpOE__RP_UART_RX_net),
		  .y({Net_303}),
		  .fb({tmpFB_0__RP_UART_RX_net[0:0]}),
		  .io({tmpIO_0__RP_UART_RX_net[0:0]}),
		  .siovref(tmpSIOVREF__RP_UART_RX_net),
		  .interrupt({tmpINTERRUPT_0__RP_UART_RX_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RP_UART_RX_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__RP_GPIO_19_net;
	wire [0:0] tmpFB_0__RP_GPIO_19_net;
	...
	cy_psoc3_pins_v1_10
		...
		RP_GPIO_19
		 (.oe(tmpOE__RP_GPIO_19_net),
		  .y({Net_160}),
		  .fb({tmpFB_0__RP_GPIO_19_net[0:0]}),
	...
	wire [0:0] tmpFB_0__RP_GPIO_16_net;
	...
	cy_psoc3_pins_v1_10
		...
		RP_GPIO_16
		 (.oe(tmpOE__RP_GPIO_16_net),
		  .y({Net_164}),
		  .fb({tmpFB_0__RP_GPIO_16_net[0:0]}),
	...
	wire [0:0] tmpOE__RP_UART_TX_net;
	wire [0:0] tmpFB_0__RP_UART_TX_net;
	wire [0:0] tmpIO_0__RP_UART_TX_net;
	wire [0:0] tmpINTERRUPT_0__RP_UART_TX_net;
	electrical [0:0] tmpSIOVREF__RP_UART_TX_net;

	cy_psoc3_pins_v1_10
		#(.id("d1d6600f-82de-4ab3-bcc5-7d46abb7176d"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		RP_UART_TX
		 (.oe(tmpOE__RP_UART_TX_net),
		  .y({Net_302}),
		  .fb({tmpFB_0__RP_UART_TX_net[0:0]}),
		  .io({tmpIO_0__RP_UART_TX_net[0:0]}),
		  .siovref(tmpSIOVREF__RP_UART_TX_net),
		  .interrupt({tmpINTERRUPT_0__RP_UART_TX_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RP_UART_TX_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__RP_GPIO_26_net;
	wire [0:0] tmpFB_0__RP_GPIO_26_net;
	...
	cy_psoc3_pins_v1_10
		...
		RP_GPIO_26
		 (.oe(tmpOE__RP_GPIO_26_net),
		  .y({Net_167}),
		  .fb({tmpFB_0__RP_GPIO_26_net[0:0]}),
	...
	wire [0:0] tmpFB_0__RP_GPIO_20_net;
	...
	cy_psoc3_pins_v1_10
		...
		RP_GPIO_20
		 (.oe(tmpOE__RP_GPIO_20_net),
		  .y({Net_173}),
		  .fb({tmpFB_0__RP_GPIO_20_net[0:0]}),
